...
public class Xls_Reader {
    ...
    private XSSFRow row =null; 	private XSSFCell cell = null;
    ...
    public String getCellData(String sheetName,String colName,int rowNum){
        try{
            ...
            if(cell==null)
                return ""; 			//System.out.println(cell.getCellType());
            ...
            if(cell.getCellType()== Cell.CELL_TYPE_STRING)
                ...
                } else if (Integer.parseInt(cellText.substring(cellText.indexOf(".")+1,cellText.length())) == 0){
